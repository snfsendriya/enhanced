              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route('user.profile_process')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                ...
                                @if($user->profile_pic != null)
                                    ...
                                    <br><br>
                                    <a href="{{url('user/remove-profile-pic')}}" class="btn btn-danger" onclick="return confirm('Are you sure ?');">Remove</a>
                                @else
