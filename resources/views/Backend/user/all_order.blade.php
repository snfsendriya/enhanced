                      ...
                      @if(isset($all_order[0]))
                        @foreach($all_order as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('user/view-order/'.$row->id)}}" class="item item-btn" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>View</span>">
                                        <i class='bx bxs-binoculars text-primary'></i>
                                    </a> &nbsp; 
                                    <a href="{{url('user/invoice/'.$row->id)}}" class="item item-btn" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Invoice</span>">
