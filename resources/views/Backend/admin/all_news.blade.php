                      ...
                      <div class="col-sm-12">
                        <div class="card-body">
                          <div class="breadcrumb-body">
                            <h5 class="card-title text-primary">All News</h5>
                          ...
                          <a href="{{url('admin/add-news')}}" class="btn btn-success btn-alignment"><i class='bx bxs-plus-circle'></i>&nbsp;Add</a>
                          <br>
                          <div class="card">
                      ...
                      @if(isset($all_news[0]))
                        @foreach($all_news as $row)
                            <tr>
                                ...
                                <td>{{ $row->title }}</td>
                                <td>
                                    <img src="{{ url('storage/uploads/News/'.$row->featured_image) }}" class="rounded" width="150" height="150" >
                                </td>
                                <td>
                                @if($row->status == 1)
                                                                <a href="{{url('admin/change-news-status/'.'0'.'/'.$row->id)}}" 
                                                            ...
                                                            @else
                                                                <a href="{{url('admin/change-news-status/'.'1'.'/'.$row->id)}}" 
                                                            ...
                                                            <a href="{{url('admin/edit-news/'.$row->id)}}" class="item item-btn" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Edit</span>">
                                                                <i class='bx bxs-pencil text-warning'></i>
                                                                </a> &nbsp;
                                                                
                                                            <a href="{{url('admin/delete-news/'.$row->id)}}" 
