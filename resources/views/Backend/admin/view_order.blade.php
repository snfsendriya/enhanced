                        ...
                        <div class="breadcrumb-body">
                            ...
                            <nav aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/all-order')}}">All Order</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($order->payment_status == "Pending")
                                                    <a href="{{url('admin/change-payment-status/'.$order->id.'/'.'Success')}}" class="btn btn-danger">Pending</a>
                                                @elseif($order->payment_status == "Success")
                                                    <a href="{{url('admin/change-payment-status/'.$order->id.'/'.'Pending')}}" class="btn btn-success">Success</a>
                                                @endif
                                            </td>
